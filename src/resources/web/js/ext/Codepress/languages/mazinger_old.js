/*
 * CodePress regular expressions for Mazinger
 * By Alejandro Usero Ruiz
 */
...
Language.syntax = [ // Mazinger
	...
	input : /(&lt;Mazinger.*?&gt;|&lt;\/Mazinger.*?&gt;)/g,
	output : '<Mazinger>$1</Mazinger>' // xsl
	},{	
	input : /(&lt;WebApplication.*?&gt;|&lt;\/WebApplication.*?&gt;)/g,
	output : '<WebApplication>$1</WebApplication>' // xsl
	},{
	input : /=(".*?")/g,
