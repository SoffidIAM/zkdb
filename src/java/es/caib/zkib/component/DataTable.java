...
public class DataTable extends XulElement implements XPathSubscriber,
	...
	public void redraw(Writer out) throws IOException {
		...
		wh.write("<table id=\"").write(uuid).write("\" z.type=\"zul.datatable.Datatable\"")
	...
	public void setColumns(String columns) {
		...
		response ( "setColumns", new AuSetAttribute(this, "columns", columns));
	}
	...
	public void setFooter(boolean footer) {
		this.footer = footer;
		response("setFooter", new AuSetAttribute(this, "footer", Boolean.toString(footer)));
	}
	...
	public void setMultiselect(boolean multiselect) {
		...
		response("setMultiselect", new AuSetAttribute(this, "multiselect", Boolean.toString(multiselect)));
	}
}
