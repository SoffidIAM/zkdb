...
public class DataDecimalbox extends org.zkoss.zul.Decimalbox implements XPathSubscriber {
	/**
	 * 
	 */
	...
	public Object clone() {
		DataDecimalbox clone = (DataDecimalbox) super.clone();
